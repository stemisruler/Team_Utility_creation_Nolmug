    ...
    <section className='Maincontent2'>
      <Swiper className="mySwiper" pagination={true} modules={[Pagination]} >
        <SwiperSlide>
          ...
          <img src='https://emmaru.com/matzip/include/pics/2021/12/15/m_91389G221602_8.jpg' className='a' alt='청사광장' />
          <span className='s'></span>
          <div className='imgbx'>
            <div>
              <img src='./img/how is it_f1.png' alt='메뉴' />
            ...
            <div>
              <img src='./img/how is it_f2.png' alt='메뉴' />
              <nav className='text_box'>
                <p>통골뱅이 소면</p>
                <p>22000원</p>
              </nav>
            ...
            <div>
              <img src='./img/how is it_f3.png' alt='메뉴' />
              <nav className='text_box'>
                <p>깐풍칠리치킨</p>
                <p>20000원</p>
              </nav>
        ...
        <SwiperSlide>
          ...
          <img src='https://mblogthumb-phinf.pstatic.net/MjAyMjEwMTZfNzcg/MDAxNjY1OTEyMDMzMjI5.36IBgtWy78teX7EIIldmbmuJqlsYQ29sQX4meTcHPHEg.LV48sT2K7eOIUK8YsHHT2kXua1Kw5ESPsGvnVTwSaBkg.JPEG.beth1223/IMG_7170.JPG?type=w800' className='a' alt='카페' />
          <span className='s'></span>
          <div className='imgbx'>
            <div>
              <img src='./img/Deep Black.png' alt='메뉴' />
              <nav className='text_box'>
                <p>딥블랙 Deep Black</p>
                <p>6500원</p>
              </nav>
            ...
            <div>
              <img src='./img/Milk Tea.png' alt='메뉴' />
              <nav className='text_box'>
                <p>밀크티 Milk Tea</p>
                <p>6500원</p>
              </nav>
        ...
        <SwiperSlide>
          <h4>오늘 이 장소 어때요</h4>
          <img src='https://search.pstatic.net/common/?src=https%3A%2F%2Fldb-phinf.pstatic.net%2F20220518_261%2F1652851841361roYC9_JPEG%2FKakaoTalk_20220518_142308270_21.jpg' className='a' alt='아쿠아리움 사진' />
          <p className='tt'>대전 엑스포 아쿠아리움</p>
          <span className='s'></span>
          <div className='imgbx1'>
            <div>
              <img src='./img/expo1.png' alt='입장권 선택지' />
              <nav className='text_box'>
                <p>엑스포 아쿠아리움 입장권</p>
                <p>21500~24900원</p>
              </nav>
            ...
            <div>
              <img src='./img/expo2.png' alt='입장권 선택지' />
              <nav className='text_box'>
